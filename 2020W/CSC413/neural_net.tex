...
\end{equation}
to prevent instability (and/or divergence). \todo{What is this?} We can bound the rate of convergence in another direction, 
\begin{equation}
...
\todo{Ill conditioned curvature, normalization}

\subsection{Gradient Descent with Momentum}
\todo{Finish from here}
