...
\end{itemize}
%\paragraph{Notes on Unrelated Regression Lines (Interaction)} 
...
\begin{itemize}
    \item \textbf{Outlier $y$:} A point $x_i$ is an outlier in the $y$ direction if $|r_i| > 2$. It is not an outlier otherwise.
...
% TODO: Adding to MLR Diagnostics
