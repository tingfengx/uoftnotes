...
evaluate $(P\land \neg Q)\vee R. ~~\neg R\vee Q. ~~\therefore \neg P\implies Q$. Notice that this is equivalent to evaluating
\begin{equation*}
    \left(\left(\left(P\land \neg Q\right)\vee R \right) \land \left(\neg R\vee Q\right)\right) \implies \neg P\implies Q
\end{equation*}
and by staring at it we see this statement is valid and only valid when $(P,Q,R)\in \{(T,T,T),(T,F,F),(F,T,T)\}$, which has a non-null set of solution. Hence the statement is consistent.
\end{document}
