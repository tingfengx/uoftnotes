...
\begin{itemize}
    ...
    %     Forward:  $\mathbf{z} =\mathbf{W}^{(1)} \mathbf{x}+\mathbf{b}^{(1)} ; \mathbf{h} =\sigma(\mathbf{z}) ; \mathbf{y} =\mathbf{W}^{(2)} \mathbf{h}+\mathbf{b}^{(2)} ; \mathcal{L} =\frac{1}{2}\|\mathbf{t}-\mathbf{y}\|^{2}$
